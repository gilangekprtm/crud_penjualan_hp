@extends('home')
@section('title', 'Edit Penjualan Hp')
@section('content')
<div class="container">
    <div class="content">
            ...
            <div class="card-header">
                ...
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <form action="{{ url('penjualan/' . $penjualan->sales_id) }}" enctype="multipart/form-data"
                                method="post">
                                @method('PUT')
                                {{ csrf_field() }}
                                <p>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input autofocus
                                            ...
                                            value="{{ old('customer_name', $penjualan->customer_name) }}">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="product_id" name="product_id" class="form-control" required>
                                            ...
                                            @foreach($products as $item)
                                                <option value="{{ $item->product_id }}" {{ $item->product_id == $penjualan->product_id ? 'selected' : '' }}>{{ $item->product_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="price" id="price" type="text" readonly value="{{ old('price', $penjualan->price) }}">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('qty') is-invalid @enderror"
                                            ...
                                            value="{{ old('qty', $penjualan->qty) }}" min="1" max="{{ $products->max('qty') }}">
                                            @error('qty')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control @error('total') is-invalid @enderror"
                                            name="total" id="total" type="text" readonly value="{{ old('total', $penjualan->total) }}">
                                    </div>
                                </div>
                                <button class="btn btn-primary" style="font-size:16px"
                                    type="submit"><span class="bi bi-save2 green-color"> Update
                                    </span></button>
                            </form>
